...
const yourName : String = "Eric Kang";
let yourPronouns : String = "He/Him";
const yourMajor : String = "Chemical Engineering";
let classification : String = "Supersenior";
let oneExcite : String = "Learning how to make websites";
let anyConcerns : String = "N/A";
let funFact : String = "I like photography";
